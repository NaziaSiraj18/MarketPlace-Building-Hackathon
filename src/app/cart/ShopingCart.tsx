...
const ShoppingCart: React.FC = () => {
  ...
  useEffect(() => {
    // Recalculate the total amount whenever cartItems or discount changes
    const cartSubtotal = cartItems.reduce((sum, item) => sum + item.price * item.quantity, 0);
    const shippingCharges = 30.0;
    const updatedTotal = cartSubtotal - cartSubtotal * discount + shippingCharges;
    setTotalAmount(updatedTotal);
  }, [cartItems, discount]); // This will trigger when cartItems or discount changes
